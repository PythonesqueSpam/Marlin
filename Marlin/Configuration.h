...
#define PID_MAX  192      // Limit hotend current while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 5.24, 5.24 }
    #define DEFAULT_Ki_LIST { 1.02, 1.02 }
    #define DEFAULT_Kd_LIST { 6.71, 6.71 }
  #else
    #define DEFAULT_Kp 5.24
    #define DEFAULT_Ki 1.02
    #define DEFAULT_Kd 6.71
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 185.95
  #define DEFAULT_bedKi 36.32
  #define DEFAULT_bedKd 634.72
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 2, -32, -0.95 }
