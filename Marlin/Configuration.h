...
// Supress these warning messages from compiler
...
#define STRING_CONFIG_H_AUTHOR "(PythonesqueSpam, SBDi3ProB)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SBDi3ProB"
...
#define PID_MAX  128      // Limit hotend current while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 6.22, 6.22 }
    #define DEFAULT_Ki_LIST { 1.18, 1.18 }
    #define DEFAULT_Kd_LIST { 8.21, 8.21 }
  #else
    #define DEFAULT_Kp 6.22
    #define DEFAULT_Ki 1.18
    #define DEFAULT_Kd 8.21
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 132.42
  #define DEFAULT_bedKi 25.86
  #define DEFAULT_bedKd 451.98
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 53.28, 53.45, 800, 409 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 4, -32, -1.5 }
